...
myBotName = "Debajunior"
botTimeZone = "America/New_York"  ##See the list full below
botAvatar = "/static/Prime.jpg" ##This can either be an image in your static folder or a web url to an image
chatBG = "/static/OptimusPrime.png"  ##This can either be an image in your static folder or a web url to an image
